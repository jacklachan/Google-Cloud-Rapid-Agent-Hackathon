...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --memory=512Mi \
  --cpu=1 \
  --set-env-vars="GOOGLE_CLOUD_PROJECT=${GOOGLE_CLOUD_PROJECT},GOOGLE_CLOUD_REGION=${GOOGLE_CLOUD_REGION},GOOGLE_GENAI_USE_VERTEXAI=true,VERTEX_AI_MODEL=${VERTEX_AI_MODEL},GITLAB_URL=${GITLAB_URL},GITLAB_PROJECT_PATH=${GITLAB_PROJECT_PATH},GITLAB_TOKEN=${GITLAB_TOKEN},GITLAB_MCP_TRANSPORT=http,FAULTLINE_FAKE_TELEMETRY=0"
